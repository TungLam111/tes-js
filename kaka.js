           ...
           <div style="
                ...
                <div style="display: flex; flex-direction: row; justify-content: start;align-items: center; gap: 10px;">
                    <div style="
                                ...
                                background: black;
                    ">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 5.18L10.59 16.6L6.35 12.36L7.76 10.95L10.59 13.78L20.59 3.78L22 5.18ZM19.79 10.22C19.92 10.79 20 11.39 20 12C20 16.42 16.42 20 12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C13.58 4 15.04 4.46 16.28 5.25L17.72 3.81C16.1 2.67 14.13 2 12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 10.81 21.78 9.67 21.4 8.61L19.79 10.22Z" fill="#fff"></path></svg>
                    </div>
                
                    <div style="
                        width: 100%;
                        display: flex;
                        justify-content: flex-start;  /* Corrected 'start' to 'flex-start' */
                        align-items: center;
                    ">
                        <div style="flex: 0 0 70%;">
                            ...
                            <div style="font-size: 14px;">
                                Cảm ơn bạn đã đặt hàng tại <a href='https://jemmia.vn' target='_blank' style='color: #2E5359; border-radius: 4px; text-decoration: none;'>website jemmia.vn</a>.
                                Sau khi nhận được đơn hàng, nhân viên chăm sóc sẽ liên hệ bạn trong thời gian sớm nhất.
                            </div>
                        </div>

                        <div style="
                            flex: 0 0 cacl(30% - 20px);  /* Updated to 30% for the remaining space */
                            font-size: 16px;
                            line-height: 24px;
                            color: black;
                            margin-left: auto;
